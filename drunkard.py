...
class Game:
    ...
    def play_game(self):
        ...
        while len(cards) >= 2:
            ...
            print("{} кладёт {}, а {} кладет {}.".format(self.player1.name, player1_card, self.player2.name, player2_card))
        ...
        print("Игра окончена! {} выйграл!".format(self.winner(self.player1, self.player2)))
